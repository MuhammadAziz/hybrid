...
var appSettings = {
    ...
    everlive: {
        apiKey: 't5jYEBVpSJumFGwO', // Put your Backend Services API key here
        scheme: 'http'
    },

    eqatec: {
        productKey: 'be738383238842398eb762ed45d77e17',  // Put your EQATEC product key here
        version: '1.0.0.0' // Put your application version here
    },
    
    feedback: {
        apiKey: '9868df70-e3d0-11e4-879e-b38beef8662c'  // Put your AppFeedback API key here
    },
